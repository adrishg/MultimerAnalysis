...
models_folder ="/Users/adrianahernandezgonzalez/Documents/YarovLab/repositories/repo-MultimerAnalysis/2i53_NMR_reference"
...
for model_ID in list(opened_models.keys()):
    ...
    for ref_ID in list(opened_refs.keys()):
        if model_ID != ref_ID:
            ...
            matchmaker_cmd = f'matchmaker #{model_ID}/A to #{ref_ID}/A'
...
output_file = "/Users/adrianahernandezgonzalez/Documents/YarovLab/repositories/repo-MultimerAnalysis/similarity_matrix_NMRvsNMR.tsv"
